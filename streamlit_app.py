...
# Input features
sl = st.slider('Nitrogen', int(0), int(140), int(0), step = int)
sw = st.slider('Phosphorus', int(5), int(145), int(5), step = int)
pl = st.slider('Potassium', int(5), int(205), int(5), step = int)
tl = st.slider('Temperature', float(8.83), float(43.67), float(min_values['Temperature']))
